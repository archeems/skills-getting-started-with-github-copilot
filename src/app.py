...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development, pickup games, and intra-school tournaments",
    ...
    # Artistic activities
    "Art Club": {
        "description": "Painting, drawing, and mixed-media workshops for all skill levels",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["isabella@mergington.edu", "liam@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and quarterly performances for the school",
    ...
    "Debate Team": {
        "description": "Practice structured debates, public speaking, and tournament prep",
